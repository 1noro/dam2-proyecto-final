...
\begin{document}
    ...
    El despliegue de la aplicación en el ámbito del servidor está pensado para realizarse en contenedores de \textit{Docker} \cite{docker:overview} haciendo el entorno lo más ligero y portable posible, permitiendo una grán escalabilidad de cara al futuro. Al principio, el proyecto se podrá montar sobre una única máquina, y gracias a estar pensado para ser muy ligero, esta máquina no requerirá de unas características desmesuradas. Se podrá desplegar el proyecto en cualquier máquina virtual en la nube, por ejemplo en una instancia de \textit{Amazon Web Services} (\textit{AWS}), \textit{Google Cloud}, \textit{Digital Ocean} o \textit{Linode}; pero también en cualquier máquina virtual en un servidor propio. Además, si se prefiere, se puede instalar el servicio en una máquina física o distribuirlo por un entorno de varios servidores, para poder atender grandes picos de tráfico.
    ...
    Mockups de formulario de nuevo thread t/o post aquí o en el aptdo 6.
