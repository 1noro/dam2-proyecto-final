...
\begin{document}
    ...
    \begin{figure}[ht]
        ...
        \label{diagram:pert}
        \begin{tikzpicture}[scale=0.70, every node/.style={transform shape}, trinode/.style={circle split, draw, path picture={\draw (path picture bounding box.center)--(path picture bounding box.south);}}]
            % level 0
            \node[trinode] (n1) {1\nodepart{lower} 00\ \ 00};
            % level 1
