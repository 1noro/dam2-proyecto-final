...
\begin{document}
    ...
    \lstinputlisting[language=Python, style=javastyle, caption=Implementación del \textit{endpoint} (GET) \texttt{/g} en la \textit{API}, label=get:threads:python]{code/get-threads.py}
