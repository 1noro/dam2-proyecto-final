...
\begin{document}
    ...
    Ahora que ya tenemos la respuesta se ejecutará la función de \textit{callback} en el método \texttt{getThreads()} del ejemplo \ref{get:threads:js}, haciendo que se visualize en el cliente web la información solicitada, de forma similar a cómo se muestra en la figura \ref{4chan:board}.
