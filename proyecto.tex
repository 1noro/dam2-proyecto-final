...
\begin{document}
    ...
    Tanto el diseño como el desarrollo de la base de datos se realizarán pensando en un servidor \emph{MariaDB}, dejando así la puerta abierta a una mayor compatibilidad con \emph{MySQL} y otras tecnologías similares. Estará pensada para ser lo mas ligera posible, permitiendo que pueda ser alojada en el mismo equipo que el servidor \emph{HTTP}. este se espera que sea un \textit{NGINX} preferiblemente, o un \textit{Apache2} como segunda opción, los dos excelentes servidores libre utilizados tanto a nivel personal como profesional.
